...
import gunn from './Breaking.avif'
      ...
      
          {
             ...
             !this.state.loading && this.state.toDisplay.map((i)=>{
                  return <div className="col-sm-4 my-3">
                      ...
                      <Newsitem title={i.title.slice(0,50)} discription={i.description?i.description.slice(0,50):"this is null"} imageurl={i.urlToImage? i.urlToImage:gunn} url1={i.url} />
